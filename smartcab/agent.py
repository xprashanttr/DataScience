...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.decay_factor_linear = 0.005
    ...
    def reset(self, destination=None, testing=False):
        ...
        #Below is decay equation with linear decay -- Q6
        self.epsilon = self.epsilon - self.decay_factor_linear
    ...
    def build_state(self):
        ...
        #state = None
        #US has right side drive, hence in case of red light also, car can turn right if LEFT traffic is not moving Forward
    ...
    def createQ(self, state):
        ...
        v_default_q = 0.0
        valid_action_default_q = dict()
        #Generate below dict structure - all actions with 0 q value
        #{'forward': 0.0, None: 0.0, 'right': 0.0, 'left': 0.0}

        if self.learning:
            if state not in self.Q :
                for i in self.valid_actions :
                    valid_action_default_q[i] = v_default_q

                self.Q[state] = valid_action_default_q
